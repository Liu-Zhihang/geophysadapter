...
### Event and split metadata

- `release_prep/PILD_release_v1/data/event_master.csv`
- `metadata/manifests/event_index_v1_strict_t2.csv`
- `metadata/manifests/strict_t2_supervised_ready_event_summary_v1.csv`
- `metadata/manifests/dlr_strict_t3_hybrid_events_v1.csv`
- `metadata/splits/split_in_domain.csv`
- `metadata/splits/split_lodo.csv`
- `metadata/splits/split_cross_trigger.csv`
...
- `release_prep/SOURCE_LICENSE_MATRIX.md`
- `metadata/manifests/strict_dataset_manifest_v1.md`

### Release-preparation assets

- `release_prep/DATA_RELEASE_PLAN_20260314.md`
- `release_prep/ZENODO_METADATA_TEMPLATE_20260314.md`
- `release_prep/ZENODO_CREATOR_FILLIN_20260314.md`
- `release_prep/ZENODO_DESCRIPTION_PILD_v1.txt`
- `release_prep/SOURCE_LICENSE_MATRIX.md`
- `release_prep/PILD_release_v1/docs/DOWNLOAD_POINTERS.md`
- `release_prep/assets/pild_global_event_coverage_t2.png`
- `release_prep/assets/pild_global_event_coverage_t2_report.md`
...
Operational source-by-source guidance is recorded in:
...
If the release receives a DOI, cite both:
...
- the source license matrix is consistent with the actual uploaded file list
