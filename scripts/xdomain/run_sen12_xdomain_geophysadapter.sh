...
TRAINER="$ROOT/scripts/xdomain/train_sen12_xdomain_geophysadapter.py"
H5="${H5:-$ROOT/processed/hybrid_pinn/sen12_s2_xdomain_v1/sen12_s2_tmr_p128.h5}"
SPLIT="${SPLIT:-$ROOT/metadata/pild_xdomain_v1/sen12_s2_logo5_v1.csv}"
OUTBASE="${OUTBASE:-$ROOT/experiments/revision2026/sen12_xdomain_geophysadapter_v1}"
