#!/usr/bin/env python3
"""Train a stronger-backbone strict_t2 change_rgb visual baseline."""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Train stronger-backbone strict_t2 change_rgb visual baseline")
    ...
    p.add_argument("--outdir", default="", help="default: experiments/strict_t2_change_rgb_strong_visual_stage0")
    ...
    p.add_argument("--epoch-samples", type=int, default=256)
...
def main() -> int:
    ...
    default_outdir = f"strict_t2_change_rgb_{args.backbone}_visual_stage0"
